...
export type AnnouncementReadWhereUniqueInput = Prisma.AtLeast<{
  userId_announcementId?: Prisma.AnnouncementReadUserIdAnnouncementIdCompoundUniqueInput
  AND?: Prisma.AnnouncementReadWhereInput | Prisma.AnnouncementReadWhereInput[]
  OR?: Prisma.AnnouncementReadWhereInput[]
  NOT?: Prisma.AnnouncementReadWhereInput | Prisma.AnnouncementReadWhereInput[]
  userId?: Prisma.StringFilter<"AnnouncementRead"> | string
...
export type AnnouncementReadUserIdAnnouncementIdCompoundUniqueInput = {
  userId: string
  announcementId: string
}
...
export type AnnouncementReadOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "announcementId" | "readAt", ExtArgs["result"]["announcementRead"]>
...
export interface AnnouncementReadDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const announcementReadWithUserIdOnly = await prisma.announcementRead.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AnnouncementReads and only return the `userId`
   * const announcementReadWithUserIdOnly = await prisma.announcementRead.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AnnouncementReads and only return the `userId`
   * const announcementReadWithUserIdOnly = await prisma.announcementRead.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
