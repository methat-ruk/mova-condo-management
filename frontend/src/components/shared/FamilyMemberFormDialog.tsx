...
import type { CreateFamilyMemberRequest, FamilyMember } from "@/types/resident";
...
function FamilyMemberForm({
  ...
  defaultValues,
  isPending,
}: Omit<FamilyMemberFormDialogProps, "open" | "onOpenChange">) {
      ...
      <div className="space-y-4 px-6 py-5">
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <label className="text-foreground text-sm font-medium" htmlFor="fmFirstName">
          ...
          <div className="space-y-1.5">
            <label className="text-foreground text-sm font-medium" htmlFor="fmLastName">
        ...
        <div className="space-y-1.5">
          <label className="text-foreground text-sm font-medium" htmlFor="fmRelationship">
        ...
        <div className="space-y-1.5">
          <label className="text-foreground text-sm font-medium" htmlFor="fmPhone">
            {t("fields.phone")}
          </label>
          <input
            id="fmPhone"
        ...
        <Dialog.Popup className="bg-card border-border fixed top-1/2 left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border shadow-xl outline-none">
          <div className="border-border flex items-center justify-between border-b px-6 py-4">
            <Dialog.Title className="text-foreground text-base font-semibold">
              {defaultValues ? t("editFamilyMember") : t("addFamilyMember")}
            </Dialog.Title>
