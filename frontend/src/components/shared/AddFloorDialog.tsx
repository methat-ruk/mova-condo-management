  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Popup className="bg-card border-border fixed top-1/2 left-1/2 z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-2xl border shadow-xl outline-none">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="px-6 py-5 space-y-1.5">
              ...
              <input
                ...
                onBlur={() => { const err = validate(value); if (err) setError(err); }}
