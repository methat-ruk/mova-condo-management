...
A full-stack condominium management system for administrators, property managers, and residents to manage daily operations in one centralized platform.
...
| Module | Description |
|---|---|
| Authentication & Users | Login, registration, profile, multi-device sessions |
| Role & Permission (RBAC) | Admin, Property Manager, Staff, Resident |
| Building & Unit Management | Buildings, floors, units, occupancy tracking |
...
- Fine-grained permission configuration per role
- Route and resource access control

### Building & Unit Management
- Building, floor, and unit management
- Unit type and size configuration
